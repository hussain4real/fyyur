...
def venues():
    ...
    venue_area = Venue.query.with_entities(
...
def search_artists():
    ...
    response = Artist.query.filter(Artist.name.ilike(
...
def create_artist_submission():
    ...
    artist = Artist(
        ...
        website=request.form['website'],
        facebook_link=request.form['facebook_link'],
        seeking_venue=request.form['seeking_venue'],  # True or False
        seeking_description=request.form['seeking_description'],
    )
    try:
...
def create_show_submission():
    ...
    show = Show(
        ...
        start_time=request.form['start_time'].split('T')[0],
    )
    try:
        db.session.add(show)
        db.session.commit()
